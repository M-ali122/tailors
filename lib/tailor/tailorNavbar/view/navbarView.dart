...
import '../../tailorHome/view/tabbarView.dart';
          ...
          Padding(
            ...
            child: BottomAppBar(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  buildIconButton(1, Svgs.order, "order"),
                  Padding(
                    padding: const EdgeInsets.only(left: 90.0),
                    child: buildIconButton(2, Svgs.camera, "Gallery",),
                  ),
                ],
              ),
            ),
      ...
      child: Container(
        ...
        child: Column(
          children: [
            SvgPicture.string(
              iconName,
              color: _currentIndex == index ? Colors.black : const Color(0xff5E5E67),
              height: 24.h,
              width: 24.w,
            ),
            Text(
